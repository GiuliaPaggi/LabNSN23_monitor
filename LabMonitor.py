...
# ------ set up telegram bot ------
bot = telegram.Bot(token='6998084381:AAHs1vtoCNurstDFbVkNOLaWA8bbkoRnpeU')
postazione = "fake"

async def send_message(text):
    async with bot:
        await bot.send_message(text=text, chat_id='807380139')

async def send_photo(photo, text):
    async with bot:
        await bot.send_message(text=text, chat_id='807380139')
        await bot.send_photo(photo=photo, chat_id='807380139')
